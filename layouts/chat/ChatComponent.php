            ...
            echo <<<CHAT_SECTION
                <div id="second-chat-part" class="relative">
                    ...
                    <div class="message-input-box relative">
                        ...
                        <input type="text" form="send-message-form" name="message" placeholder="Type a new message" id="chat-text-input" class="chat-input-style send-button" style="padding-left: 40px">
                ...
                <div class="message-global-container">
                    <div class="current-user-message-container">
                        ...
                        <div class="message-wrapper relative">
                            <p class="regular-text text-dark">$message_text</p>
