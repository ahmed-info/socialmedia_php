...
<header>
    <div id="top-header">
        ...
        <div class="inline-logo-separator">ok</div>
        <div class="row-v-flex">
            <form action="<?php echo Config::get("root/path") . htmlspecialchars('search.php'); ?>" method="GET" id="header-search-form">
                <input type="text" name="q" value="<?php echo isset($_GET["q"]) ? trim(htmlspecialchars($_GET["q"])) : '' ?>" class="form-control me-2" placeholder="Search for friends, posts, events ..">
