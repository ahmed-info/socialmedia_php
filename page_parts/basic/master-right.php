            ...
            if(empty($friends)) {
                echo <<<EMPTY
                    <div class="flex-column" style="margin-top: 40px">
                        ...
                        <p style="text-align: center" class="text-black">Try to add your friends, follow celebrities ..</p>
                        <p style="text-align: center" class="text-bkack">click <a href="$search_url" class="link" style="color: rgb(66, 219, 66)">here</a> to go to the search page</p>
                    </div>
EMPTY;      
            } else {
