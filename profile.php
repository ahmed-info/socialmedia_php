...
function post_date_latest_sort($post1, $post2) {
   ...
   if($post1->get_property('post_date') < $post2->get_property('post_date')){
return 0;
   }elseif ($post1->get_property('post_date') > $post2->get_property('post_date')){
return -1;
   }else{
    return 1;
   }
//    return $post1->get_property('post_date') < $post2->get_property('post_date') ? 0: $post1->get_property('post_date') > $post2->get_property('post_date');
}
...
<head>
    ...
    <title>profile - <?php echo $fetched_user->getPropertyValue("username"); ?></title>
                ...
                <div id="posts-container">
                    <?php if(count($posts) == 0) { ?>
                        <div id="empty-posts-message">
                            <h2 class="text-black">Try to add friends, or follow them to see their posts ..</h1>
